...
MIGRATION_MODULES = {"sites": "scaleos.contrib.sites.migrations"}
...
ADMINS = [("""OeleGeirnaert""", "oelegeirnaert@scaleos.net")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "scaleos.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "scaleos.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "scaleos.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "scaleos.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "ScaleOS API",
    "DESCRIPTION": "Documentation of API endpoints of ScaleOS",
    "VERSION": "1.0.0",
...
ENCRYPTION_KEY = env("DJANGO_ENCRYPTION_KEY", None)
